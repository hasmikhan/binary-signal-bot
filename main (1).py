...
ADX_PERIOD = 14
ADX_THRESHOLD = 20   # ADX এর নিচে মানে market sideways/choppy -> signal স্কিপ হবে
...
def calculate_signal(candles_main, candles_higher):
    ...
    # MACD কে MA trend-এর সাথে মিলিয়ে দেখা - না মিললে HOLD
    if signal_main == "BUY" and not macd_bullish:
        return "HOLD", rsi, adx, macd_hist
    if signal_main == "SELL" and macd_bullish:
        return "HOLD", rsi, adx, macd_hist
